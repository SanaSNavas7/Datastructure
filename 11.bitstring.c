...
int uni[50], set1[50], set2[50], num, num1, num2, i, temp, exists, j=0, 
    bitstringset1[50], bitstringset2[50], choice;
...
void main(){
    ...
    for(i = 0; i < num; i++){
        printf("%d ", uni[i]);  // Adding a space between elements
    }
    ...
    printf("First Set: ");
    for(i = 0; i < num1; i++){
        printf("%d ", set1[i]);  // Adding a space between elements
    }
    ...
    printf("Second Set: ");
    for(i = 0; i < num2; i++){
        printf("%d ", set2[i]);  // Adding a space between elements
    }
